#!/usr/bin/env python3
"""
Upload topic HTML files to Supabase Storage in batches
"""
...
SERVICE_KEY = "REDACTED_USE_ENV_VAR"
...
def main():
    ...
    for i, f in enumerate(files[:100]):  # First 100 files
    ...
    # Save manifest
    with open("/home/z/my-project/topics_manifest.json", 'w') as f:
